...
class pyNode(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(String, 'default_or_not', 10)
    ...
    def set_goal_pos_callback(self, data):
        ...
        chessPositions = {
            ...
            'd7': [c(144.43), c(164.68), c(150.59), c(150.29), c(166.41), c(144.43), c(153.79), c(180.47), c(185.45), c(166.41)],
            'd6': [c(144.14), c(165.53), c(157.62), c(162.60), c(166.41), c(144.14), c(152.34), c(163.18), c(177.00), c(166.41)],
            'd5': [c(149.41), c(150.80), c(131.84), c(153.52), c(166.41), c(149.41), c(143.26), c(150.59), c(171.97), c(166.41)],
            'd4': [c(149.71), c(142.09), c(125.68), c(153.81), c(166.41), c(149.71), c(144.43), c(142.09), c(173.80), c(166.41)],
            ...
            'e8': [c(164.65), c(168.16), c(174.32), c(162.89), c(166.41), c(164.65), c(165.53), c(179.30), c(162.60), c(166.41)],
            ...
            'e5': [c(159.45), c(150.80), c(131.84), c(153.52), c(166.41), c(159.45), c(143.26), c(150.59), c(171.97), c(166.41)],
            'e4': [c(159.15), c(142.09), c(125.68), c(153.81), c(166.41), c(159.15), c(144.43), c(142.09), c(172.80), c(166.41)],
            ...
            'f6': [c(170.51), c(158.79), c(155.86), c(160.45), c(166.41), c(170.51), c(148.54), c(160.84), c(176.73), c(166.41)],
            'f5': [c(168.11), c(141.80), c(131.84), c(153.52), c(166.41), c(168.11), c(143.26), c(150.59), c(173.97), c(166.41)],
        ...
        # c(189.21), c(145.90), c(97.56), c(134.47), c(166.41)
        # c(205.66)
        # c(205.66), c(122.75), c(97.56), c(134.47), c(166.41)

        # new close and open
        close = 114
        open = 160

        default_msg, not_default_msg = String(), String()
        default_msg.data = "default"
        not_default_msg.data = "not"
        ...
        def moveToBeforeWithout(loc: str, speed=60):
            ...
            second_difference = (d(positions[1]) - d(positions[6])) / 3
            second_speed = second_difference / 0.111
            third_difference = (d(positions[2]) - d(positions[7])) / 3
            third_speed = third_difference / 0.111
            fourth_difference = (d(positions[3]) - d(positions[8])) / 3
        ...
        def moveToAfterWithout(loc: str, speed=60):
            ...
            second_difference = (d(positions[6]) - d(positions[1])) / 3
            second_speed = second_difference / 0.111
            third_difference = (d(positions[7]) - d(positions[2])) / 3
            third_speed = third_difference / 0.111
            fourth_difference = (d(positions[8]) - d(positions[3])) / 3
            fourth_speed = fourth_difference / 0.111
        ...
        def moveOut(speed=65):
            ...
            time.sleep(2)
            dxl_comm_result, dxl_error = packetHandler.write2ByteTxRx(portHandler, 1, ADDR_MOVING_SPEED, speed)
            dxl_comm_result, dxl_error = packetHandler.write2ByteTxRx(portHandler, 1, ADDR_GOAL_POSITION, int(c(206)))
            time.sleep(1)
            servo_ids = [2, 3, 4]
            for servo_id, position in zip(servo_ids, chessPositions['after_out'][1:4]):
                print("Set Goal Position of ID %s = %s %s" % (servo_id, int(position), position*300/1023))
                dxl_comm_result, dxl_error = packetHandler.write2ByteTxRx(portHandler, servo_id, ADDR_MOVING_SPEED, speed)
                dxl_comm_result, dxl_error = packetHandler.write2ByteTxRx(portHandler, servo_id, ADDR_GOAL_POSITION, int(position))
                dxl_comm_result, dxl_error = packetHandler.write2ByteTxRx(portHandler, 5, ADDR_GOAL_POSITION, int(c(close)))
