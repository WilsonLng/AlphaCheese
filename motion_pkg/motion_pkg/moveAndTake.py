...
class pyNode(Node):
    ...
    def set_goal_pos_callback(self, data):
        ...
        chessPositions = {
            ...
            'd6': [c(144.14), c(165.53), c(157.62), c(162.60), c(166.41), c(144.14), c(152.34), c(163.18), c(173.44), c(166.41)],
            ...
            'e6': [c(161.72), c(165.53), c(157.62), c(162.60), c(166.41), c(161.72), c(152.34), c(163.18), c(173.44), c(166.41)],
